...
// const DEFAULT_TARGET_LANG = "EN"; // Default language if none provided
...
//     body: JSON.stringify({
//       text: [text],
//       target_lang: targetLang, // Use dynamic targetLang
//     }),
//   });
...
// /**
//  * Translates text layers in a PSD file and saves the translated version to GCS
//  * @param {Buffer} inputPsdBuffer - Buffer of the input PSD file
//  * @param {string} inputFileName - Name of the input file
//  * @param {string} outputFileName - Name of the output file in GCS
//  * @param {string} targetLang - Target language to use for translation
//  * @returns {Promise<void>}
//  */
// async function translatePsd(inputPsdBuffer, inputFileName, outputFileName, targetLang = DEFAULT_TARGET_LANG) {
//   try {
//     console.log("Authenticating with Adobe...");
//     const accessToken = await generateIMSToken();

//     console.log("Fetching PSD document manifest...");
//     const manifest = await getDocumentManifest(accessToken, imsConfig.clientId, inputPsdBuffer, inputFileName);
...
//     const inputUrl = await uploadToGCS(inputPsdBuffer, inputFileName);
...
//     console.log("Translation completed! File uploaded to GCS.");
//   } catch (error) {
...
//       await translatePsd(inputPsdBuffer, fileName, outputPsdPath, "FR"); // Example with French
//     } catch (error) {
